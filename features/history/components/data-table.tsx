...
import { GripVerticalIcon, CircleCheckIcon, LoaderIcon, ClockIcon, EllipsisVerticalIcon, Columns3Icon, ChevronDownIcon, PlusIcon, ChevronsLeftIcon, ChevronLeftIcon, ChevronRightIcon, ChevronsRightIcon } from "lucide-react"
    ...
    cell: () => (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-32">
          ...
          <DropdownMenuItem>Retake</DropdownMenuItem>
    ...
    >
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select
          defaultValue="sessions"
          items={[
            { label: "Session history", value: "sessions" },
        ...
        <TabsList className="hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:bg-muted-foreground/30 **:data-[slot=badge]:px-1 @4xl/main:flex">
          ...
          <TabsTrigger value="by-role">
            By role <Badge variant="secondary">3</Badge>
          </TabsTrigger>
          <TabsTrigger value="flagged">
            Flagged <Badge variant="secondary">2</Badge>
          </TabsTrigger>
        </TabsList>
      ...
      <TabsContent value="by-role" className="flex flex-col px-4 lg:px-6">
    ...
    <Drawer swipeDirection={isMobile ? "down" : "right"}>
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          <DrawerTitle>{item.role}</DrawerTitle>
          <DrawerDescription>
